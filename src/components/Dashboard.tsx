                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-sm text-zinc-300">
                            ...
                            <span className="whitespace-nowrap text-zinc-200">Валовка: {participant.revenue.totalScore}</span>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          >
            ...
            <div className="border border-zinc-800 bg-zinc-900/50 p-6">
              ...
              <div className="mt-6 rounded border border-amber-700/40 bg-zinc-950/70 p-4">
                <p className="text-sm text-zinc-400">Общий вес параметров: {parameters.reduce((sum, p) => sum + p.weight, 0)} баллов</p>
              </div>
            </div>
          </div>
        </div>
